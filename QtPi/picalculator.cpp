...
double AtanCalculator::calculate(int steps) const {
    double sum = 0.0;
    double sign = 1.0;
...
double IntegrateCalculator::calculate(int steps) const {
    double sum = 0.0;
...
double MonteCarloCalculator::calculate(int steps) const {
...
double TwoAtanCalculator::atan(double x, int steps) const {
    double sum = 0.0;
    double pow_x = x;
    for (int i=0; i<steps;i++) {
            sum +=pow_x/(2*i+1);
...
double TwoAtanCalculator::calculate(int steps) const {
